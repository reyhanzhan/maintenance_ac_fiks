...
@section('title', 'Koordinator Surat Jalan')
@section('page-title', 'Koordinator Surat Jalan')

@section('content')
<div class="max-w-5xl">
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
        <div class="px-5 py-4 border-b border-gray-100">
            <h3 class="font-semibold text-gray-900">Pengaturan Nama Mengetahui Surat Jalan per Rumah Sakit</h3>
            <p class="text-sm text-gray-500 mt-1">Nama di sini akan otomatis dipakai pada bagian Mengetahui di PDF Surat Jalan.</p>
        </div>
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="bg-gray-50 text-gray-600 uppercase text-xs tracking-wider">
                        ...
                        <th class="px-5 py-3 text-left">Nama Mengetahui</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50/50">
                        ...
                        <td class="px-5 py-3">
                            <form action="{{ route('admin.koordinator-surat-jalan.update', $rs) }}" method="POST" class="flex items-center gap-2">
                                @csrf
                                @method('PUT')
                                <input type="text" name="mengetahui_surat_jalan" value="{{ old('mengetahui_surat_jalan', $rs->mengetahui_surat_jalan) }}" placeholder="Contoh: M. Choiruddin"
