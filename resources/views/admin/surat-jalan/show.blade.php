...
<div class="bg-white rounded-2xl border border-gray-200 p-5 mb-6">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div>
            <p class="text-xs text-gray-400 uppercase tracking-wider mb-0.5">Deskripsi Pekerjaan</p>
            <p class="font-medium text-gray-900">{{ $suratJalan->deskripsi_pekerjaan ?: '-' }}</p>
        </div>
        <div>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr>
                    ...
                    <td class="px-5 py-3 font-medium text-gray-900">{{ $item->nama_ruangan }}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
...
<a href="{{ route('admin.surat-jalan.pdf', $suratJalan->id) }}" class="inline-flex items-center gap-2 px-5 py-2.5 bg-red-50 text-red-600 hover:bg-red-100 rounded-xl text-sm font-medium transition">
