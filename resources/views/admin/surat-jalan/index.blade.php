...
<div class="bg-white rounded-2xl border border-gray-200 p-5 mb-6">
    <form method="GET" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
        ...
        <div class="flex gap-2">
            ...
            <a href="/admin/surat-jalan" class="px-4 py-2 border border-gray-300 text-gray-600 hover:bg-gray-50 text-sm font-medium rounded-lg transition">Reset</a>
        </div>
    </form>
</div>
                ...
                <tr class="hover:bg-gray-50/50 transition">
                    ...
                    <td class="px-5 py-3 text-center">
                        <div class="flex items-center justify-center gap-1">
                            ...
                            <a href="{{ route('admin.surat-jalan.pdf', $sj->id) }}" class="p-1.5 text-red-500 hover:bg-red-50 rounded-lg transition" title="Export PDF">
